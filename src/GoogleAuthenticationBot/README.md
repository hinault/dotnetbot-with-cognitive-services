...
## Visual Studio
- Open GoogleAuthenticationBot.csproj in Visual Studio.
...
- File -> Open bot and open [GoogleAuthenticationBot.bot](GoogleAuthenticationBot.bot).
