...
namespace GoogleAuthenticationBot
{
    ...
    public class GoogleAuthenticationBotBot : IBot
    {
        ...
        public GoogleAuthenticationBotBot(ConversationState conversationState, ILoggerFactory loggerFactory)
        {
            ...
            _accessors = new GoogleAuthenticationBotAccessors(conversationState)
            {
                CounterState = conversationState.CreateProperty<CounterState>(GoogleAuthenticationBotAccessors.CounterStateName),
            };
